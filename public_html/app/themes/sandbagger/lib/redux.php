    ...
    class Redux_config {
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'menu_title'        => __('Sandbagger Options', 'redux-framework'),
                ...
                'page_slug'         => 'sandbagger_options',              // Page slug used to denote the panel
            ...
            $this->args['intro_text'] = __('<p></p>', 'redux-framework');

            // Add content after the form.
            $this->args['footer_text'] = __('<p></p>', 'redux-framework');
        }

    }
    
    global $reduxConfig;
    $reduxConfig = new Redux_config();
}
